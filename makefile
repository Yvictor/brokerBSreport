...
get-twse-bsreport:
	SENTRY_DNS=${SENTRY_DNS} WORKER_NAME=twse SLP=4.7 TWSE_ORIGIN_FOLDER=0Bxlih4lHCRlmeTRCUkFpd2hkcm8  python -m twse

get-tpex-bsreport:
	SENTRY_DNS=${SENTRY_DNS} WORKER_NAME=tpex SLP=4.5 TPEX_ORIGIN_FOLDER=0Bxlih4lHCRlmd0hFVktsY0lrRzg  python -m tpex &
