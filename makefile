...
get-bsreport: get-twse-bsreport get-tpex-bsreport

# to do -> need to build cron.env
# ${WORKDIR}/cron/cron.env; python -m twse
get-twse-bsreport:
	SENTRY_DNS=${SENTRY_DNS} WORKER_NAME=twse SLP=3.1 TWSE_ORIGIN_FOLDER=0Bxlih4lHCRlmeTRCUkFpd2hkcm8  python -m twse &
